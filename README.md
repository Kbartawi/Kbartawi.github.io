...
- **Frame:** version 2.0.0 (1) is signed, processed by Apple and available to the invited owner through internal TestFlight as “Frame: Photos to Reels”; the app display name remains Frame. The offline native editor supports resumable drafts, gallery recovery and safer import, export and voice saving, with 44 Simulator tests. It has no Frame login or cloud AI integration. Real iPhone installation and acceptance remain unverified. There is no external/public beta or App Store release. The separate web studio remains a fixture-based public sample; its private backend offers Kling and Seedance with 174 mocked tests. AI creative acceptance remains pending. A follow-up simulator review passed editing/relaunch, gallery recovery, missing-video retry and Share to Files; landscape framing and template quality remain improvement priorities.
