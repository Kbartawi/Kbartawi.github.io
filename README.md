...
- **Frame:** Voice workspace in internal beta. Build 4 remains the only verified assigned internal release; signed build 3.0.0 (7) uploaded at 13:18:15 Dubai on 20 September. Build 7 improves visual fidelity, unsaved edit/draft protection, stale-edit handling and recording-resume setup. Its full suite executed 103 checks: 102 passed and one device-only skip. Simulator draft save/reopen and native Calendar cancel/save callbacks were verified. Build 7 Apple processing completion and group assignment remain unverified. Physical recording, device AI and language quality remain unverified; Simulator audio preparation stalled before recording and produced no audio export. Optional local AI requires iOS 26.4+ and compatible enabled hardware.
