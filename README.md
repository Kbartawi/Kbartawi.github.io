...
- **Frame:** complete AI-directed films are the goal; the founder rejected the slideshow as product acceptance. Backend 0.8.5 implements separate writing/direction/edit/review stages, validated timestamps, explicit routes and exact-image approval before animation for new drafts. 189 mocked tests and a browser fixture verify the safeguards; no live creative acceptance is claimed. Perceptual review, richer editing and the mobile connection remain unfinished. Owner TestFlight 2.0.0 (1) remains a separate offline editor with 44 native tests and no cloud AI/login. No new paid generation ran.
