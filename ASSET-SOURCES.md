...
| Portfolio asset | Origin | Meaning |
| --- | --- | --- |
| media/dubai-downtown.webp | Dubai Game / assets/images/CAL-LOC-01-1-C.png | Existing generated Downtown visual development; not gameplay or verified exact geography |
| media/dubai-marina.webp | Dubai Game / assets/images/LOC-02-1-marina-establishing.png | Existing generated Marina visual development; not gameplay or approved final art |
| media/frame-film-concept.webp | Generated for this portfolio on 17 September 2026 using the built-in image tool | Cinematic coastal-driving illustration inside a concept studio interface; not evidence of a completed Frame production |
| media/manzl-apartment.webp | Existing portfolio image | Illustrative property, not a live listing |
| media/quote-review-current.png | Existing Quote Operations sample screenshot | Actual interface with fictional sample data |
